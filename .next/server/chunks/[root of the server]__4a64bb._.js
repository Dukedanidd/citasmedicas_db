...
"[project]/app/api/historial/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        console.log('[GET /api/historial] Parámetros:', {
            historialId,
            expedienteId
        });
        if (!historialId && !expedienteId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Se requiere ID de historial o expediente'
            }, {
                status: 400
            });
        }
    ...
    `;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(historialId ? rows[0] : rows);
    } catch (error) {
...
async function POST(request) {
    ...
    try {
        ...
        const [expediente] = await conn.execute('SELECT expediente_id FROM expedientes WHERE expediente_id = ?', [
            expediente_id
        ]);
        if (!expediente[0]) {
            await conn.rollback();
    ...
    `, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Error al crear registro de historial médico'
        }, {
            status: 500
        });
    } finally{
...
async function PUT(request) {
    ...
    try {
        ...
        if (!historial_id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'historial_id es requerido'
            }, {
                status: 400
            });
        }
        ...
        const [historial] = await conn.execute('SELECT historial_id FROM historial_medico WHERE historial_id = ?', [
            historial_id
        ]);
        if (!historial[0]) {
            await conn.rollback();
    ...
    `, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Registro de historial médico actualizado exitosamente'
        });
    } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Error al actualizar registro de historial médico'
        }, {
            status: 500
        });
    } finally{
...
async function DELETE(request) {
    ...
    try {
        ...
        await conn.execute('DELETE FROM historial_medico WHERE historial_id = ?', [
            historialId
        ]);
        await conn.commit();
        console.log('[DELETE /api/historial] Transacción completada');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Registro de historial médico eliminado exitosamente'
        });
    } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Error al eliminar registro de historial médico'
        }, {
            status: 500
        });
    } finally{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4a64bb._.js.map