...
"[project]/app/api/doctores/[id]/completo/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    console.log('[GET /api/doctores/[id]/completo] Iniciando petición...');
    try {
        const { id } = params;
        ...
        console.log('[GET /api/doctores/[id]/completo] Conexión exitosa');
        ...
        const [rows] = await conn.execute(`SELECT u.user_id AS doctor_id, u.primer_nombre, u.segundo_nombre, u.apellido_paterno, u.apellido_materno,
       ...
       WHERE u.user_id = ?`, [
        ...
        await conn.end();
        console.log('[GET /api/doctores/[id]/completo] Conexión cerrada');
        if (!rows[0]) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b6c523._.js.map