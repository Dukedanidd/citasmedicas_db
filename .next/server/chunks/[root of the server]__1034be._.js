...
async function authenticateUser(email, password) {
    try {
        ...
        const [admins] = await __TURBOPACK__imported__module__$5b$project$5d2f$database$2f$connection$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].promise().query('SELECT user_id as id, email, password, "admin" as rol FROM usuarios WHERE email = ? AND password = ?', [
            email,
            password
        ]);
        // Si no es admin, buscamos en la tabla doctores
        const [doctors] = await __TURBOPACK__imported__module__$5b$project$5d2f$database$2f$connection$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].promise().query('SELECT doctor_id as id, email, password, "doctor" as rol FROM doctores WHERE email = ? AND password = ?', [
            email,
            password
        ]);
        // Si no es doctor, buscamos en la tabla pacientes
        const [patients] = await __TURBOPACK__imported__module__$5b$project$5d2f$database$2f$connection$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].promise().query('SELECT paciente_id as id, email, password, "paciente" as rol FROM pacientes WHERE email = ? AND password = ?', [
            email,
            password
        ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1034be._.js.map