...
"[project]/app/api/citas/doctor/[doctorId]/[fecha]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const GET = async (request, { params })=>{
    ...
    try {
        ...
        console.log('[GET /api/citas/doctor/[doctorId]/[fecha]] Parámetros:', {
            doctorId,
            fecha
        });
        // Validar parámetros
        ...
        const [rows] = await conn.execute(`SELECT c.*, 
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__071b86._.js.map