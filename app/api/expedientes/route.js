...
export async function GET(request) {
  ...
  try {
    ...
    console.log("[GET /api/expedientes] Parámetros:", {
      expedienteId,
      pacienteId,
    });
...
export async function DELETE(request) {
  ...
  try {
    ...
    if (!expedienteId) {
      console.log(
        "[DELETE /api/expedientes] ID de expediente no proporcionado",
      );
      return NextResponse.json(
    ...
    await conn.execute("DELETE FROM expedientes WHERE expediente_id = ?", [
      expedienteId,
    ]);
